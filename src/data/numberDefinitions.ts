...
export const numberDefinitions: Record<number, NumberDefinition> = {
  ...
  9: {
    digit: 9,
    startPoint: { x: 0.5, y: 0.12 },
    svgPath: 'M 50,12 C 70,12 78,25 78,38 C 78,52 65,58 50,58 C 35,58 22,52 22,38 C 22,25 32,12 50,12 M 78,38 C 78,55 75,70 65,80 C 55,90 40,88 30,82',
    strokes: [
      {
        id: '9-1',
        svgPath: 'M 50,12 C 70,12 78,25 78,38 C 78,52 65,58 50,58 C 35,58 22,52 22,38 C 22,25 32,12 50,12 M 78,38 C 78,55 75,70 65,80 C 55,90 40,88 30,82',
