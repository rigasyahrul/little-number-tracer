...
export const numberDefinitions: Record<number, NumberDefinition> = {
  ...
  9: {
    digit: 9,
    startPoint: { x: 0.7, y: 0.35 },
    svgPath: 'M 70,35 C 70,18 55,12 42,12 C 28,12 18,22 18,35 C 18,48 28,55 42,55 C 56,55 70,48 70,35 L 70,35 C 70,50 68,65 60,78 C 52,88 38,88 30,82',
    strokes: [
      {
        id: '9-1',
        svgPath: 'M 70,35 C 70,18 55,12 42,12 C 28,12 18,22 18,35 C 18,48 28,55 42,55 C 56,55 70,48 70,35 L 70,35 C 70,50 68,65 60,78 C 52,88 38,88 30,82',
