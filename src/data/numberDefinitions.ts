 ...
 * Detection points are generated automatically from SVG paths at runtime
 * using sampleSvgPathPoints() to ensure perfect alignment with the dotted stroke lines.
 * 
 * Each number has:
 * - svgPath: Complete path for rendering the thick background number
 * - strokes: Individual strokes with their own svgPath (points are auto-generated)
 */
...
export const numberDefinitions: Record<number, NumberDefinition> = {
  ...
  6: {
    digit: 6,
    startPoint: { x: 0.65, y: 0.18 },
    svgPath: 'M 65,18 C 50,12 30,15 25,30 C 20,50 22,62 25,70 C 28,78 38,88 55,88 C 72,88 80,78 80,65 C 80,52 70,45 55,45 C 40,45 28,52 25,65',
    strokes: [
      {
        id: '6-1',
        svgPath: 'M 65,18 C 50,12 30,15 25,30 C 20,50 22,62 25,70 C 28,78 38,88 55,88 C 72,88 80,78 80,65 C 80,52 70,45 55,45 C 40,45 28,52 25,65',
  ...
  9: {
    digit: 9,
    startPoint: { x: 0.3, y: 0.82 },
    svgPath: 'M 30,82 C 40,88 55,85 62,75 C 70,62 72,50 72,38 C 72,25 65,15 50,15 C 35,15 25,25 25,38 C 25,52 35,58 50,58 C 65,58 72,48 72,38',
    strokes: [
      {
        id: '9-1',
        svgPath: 'M 30,82 C 40,88 55,85 62,75 C 70,62 72,50 72,38 C 72,25 65,15 50,15 C 35,15 25,25 25,38 C 25,52 35,58 50,58 C 65,58 72,48 72,38',
